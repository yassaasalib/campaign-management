...
export class CampaignService {
  ...
  private campaigns: Campaign[] = this.initialCampaigns.map(campaign => ({
    ...campaign,
    startDate: new Date(campaign.startDate),
    endDate: new Date(campaign.endDate)
  }));
  private campaignsUpdated = new BehaviorSubject<Campaign[]>(this.campaigns);
